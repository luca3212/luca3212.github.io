...
function addLista(data){
    ...
    nuevaLi.innerHTML =`
                ...
                <div id="div-botones">
                    <!-- boton copiar -->
                    <button id="boton"  onclick = "copiarLista(${data.id_tarea})"><svg style="width:24px;height:24px" viewBox="0 0 24 24">
                    ...
                    <!-- boton compartir -->
                    <button id="boton"  onclick ="compartirLista(${data.id_tarea})"><svg style="width:24px;height:24px" viewBox="0 0 24 24">
                    ...
                    <!-- boton borrar -->
                    <button id="boton"  onclick ="deleteLista(${data.id_tarea})"><svg style="width:24px;height:24px" viewBox="0 0 24 24">
